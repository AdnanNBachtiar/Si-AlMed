...
<div class="container-fluid position-relative p-0">
        ...
        <div class="container py-5 pt-lg-0">
            <div class="row gx-0">
                ...
                <div class="bg-primary primary d-flex align-items-center justify-content-center p-4" style="height: 150px;">
                        ...
                        <div class="ps-4">
                            <h1 class="text-light"> Detail Alat Medis </h1> 
                        </div>
                    </div>
                </div>
            </div>
    ...
    <!-- Conten Utama -->
    <div class="container">
    <form action="tambah.php" method="GET" class="row g-3">
        <div class="col-md-6">
            <label for="recipient-name" class="col-form-label">Nama Alat</label>
            <input type="text" class="form-control" id="namaalat" name="namaalat" value="<?php echo $data['nama_alat']; ?> " readonly>
        </div>
        <!-- Tambahkan elemen-elemen lainnya sesuai kebutuhan -->
        <div class="col-md-6">
            <label for="recipient-name" class="col-form-label">Serial Number</label>
            <input type="text" class="form-control" id="snalat" name="snalat" value="<?php echo $data['sn']; ?>"readonly>
        </div>
        <!-- Tambahkan elemen-elemen lainnya sesuai kebutuhan -->
        <div class="col-md-6">
            <label for="recipient-name" class="col-form-label">No Inventaris</label>
            <input type="text" class="form-control" id="ninven" name="ninven" value="<?php echo $data['no_inventaris']; ?>" readonly>
        </div>
        <div class="col-md-6">
        <label for="recipient-name" class="col-form-label">Tanggal Kalibrasi</label>
        <input type="date" class="form-control" id="tglkalibrasi" name="tglkalibrasi" value="<?php echo $data['tgl_kalibrasi']; ?>" readonly>
        </div>
        <!-- Tambahkan elemen-elemen lainnya sesuai kebutuhan -->
        <div class="col-md-6">
        <label for="recipient-name" class="col-form-label">Tanggal Kalibrasi Ulang</label>
        <input type="date" class="form-control" id="kalibrasiulang" name="kalibrasiulang" value="<?php echo $data['kalibrasi_ulang']; ?>" readonly>
        </div>
                <!-- Tambahkan elemen-elemen lainnya sesuai kebutuhan -->
                <div class="col-md-6">
        <label for="recipient-name" class="col-form-label">Lokasi Alat</label>
        <input type="text" class="form-control" id="kalibrasiulang" name="kalibrasiulang" value="<?php echo $data['lokasi']; ?>" readonly>
        </div>
                <!-- Tambahkan elemen-elemen lainnya sesuai kebutuhan -->
        <div class="col-md-6">
        ...
        <input type="text" class="form-control" id="kalibrasiulang" name="kalibrasiulang" value="<?php echo $data['status']; ?>" readonly>
        </div>
                <!-- Tambahkan elemen-elemen lainnya sesuai kebutuhan -->
                <div class="md-3">
            <label for="recipient-name" class="col-form-label">Catatan</label>
            <textarea class="form-control" id="catatanalat" name="catatanalat" rows="3" value="<?php echo $data['catatan']; ?>" readonly></textarea>
        </div>
    </form>
</div>
