    ...
    while ($row1 = $hasilkan->fetch_assoc()){
        ...
        if($selisih <= 7 && $selisih >= 0) {
            $pesanArray[] = array (
                ...
                'sn' => $row1['sn'],
                'noiv' => $row1['no_inventaris'],
                'tgl_kalibrasi' => $row1['tgl_kalibrasi'],
                'kalibrasi_ulang' => $row1['kalibrasi_ulang'],
                'lokasi_alat' => $row1['lokasi'],
                'petugas' => $row1['petugas'],
                'status' => $row1['status'],
            );
            ...
            <div class="row gx-0">
                ...
                <div class="bg-primary primary d-flex align-items-center justify-content-center p-4" style="height: 150px;">
                        ...
                        <div class="ps-4">
                            ...
                            <h1 class="mb-0" data-toggle="counter-up"> <?=$count3; ?></h1>
                        </div>
                    </div>
                </div>
            </div>
...
while ($tampil = mysqli_fetch_array($ambildata)){
    ...
    echo "
        ...
        <td style= text-align:center;> $pesan[sn]</td>
        <td style= text-align:center;> $pesan[noiv]</td>
        <td style= text-align:center;> $tgl_kalibrasi</td>
        <td style= text-align:center;> $tgl_kalibrasi_ulang</td>
        <td style= text-align:center;> $pesan[lokasi_alat]</td>
        <td style= text-align:center;> $pesan[petugas]</td>
        <td style='color: $warna; font-weight:bold; text-align:center;'> $pesan[status]</td>
        <td style= text-align:center;> <a href='delete.php?hapus=$tampil[id]' style='float:center;' onClick = \"return confirm('Yakin akan menghapus data?');\"> hapus</a>
        <a href='?update=$tampil[id]' data-bs-toggle='modal' data-bs-target='#modalupdate'  style='float:right; margin-right:10px ;border-left: 1px solid black; padding-left: 25px; margin-left: 1px;'> Update</a>
</td>
