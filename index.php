...
// Menjumlahkan data dengan Status Valid
        ...
        <div class="container py-5 pt-lg-0">
            <div class="row gx-0">
                ...
                <div class="col-lg-3 wow zoomIn" data-wow-delay="0.6s">
                    <a href="tidakvalid.php" class="text-decoration-none">
                    <div class="bg-primary shadow d-flex align-items-center justify-content-center p-4" style="height: 150px;">
                    <div class="bg-white d-flex align-items-center justify-content-center rounded mb-2" style="width: 60px; height: 60px;">
                    ...
                    <h1 class="text-white mb-0" data-toggle="counter-up"><?=$totalTidakValid; ?></h1>
                </div>
        </div>
    </a>
</div>
    ...
    echo "
        <tr style='font-size: 14px;'>
            ...
            <td style='text-align:center;'> 
                ...
                <a href='edit.php?id=$tampil[id]' style='float:right; margin-right:10px ; padding-left: 15px; margin-left: 1px; padding-right:5px;'> Edit</a>
                </td>
        </tr>";
