...
<div class="container-fluid position-relative p-0">
    ...
    <form action="update.php" method="POST" class="row g-3">
        <div class="col-md-6">
            ...
            <input type="text" class="form-control" id="namaalat" name="namaalat" placeholder="Nama Alat" value="<?php echo $data['nama_alat']; ?> ">
        </div>
        ...
        <input type="date" class="form-control" id="tglkalibrasi" name="tglkalibrasi" value="<?php echo $data['tgl_kalibrasi']; ?>" >
        </div>
        <!-- Tambahkan elemen-elemen lainnya sesuai kebutuhan -->
        <div class="col-md-6">
        <label for="recipient-name" class="col-form-label">Tanggal Kalibrasi Ulang</label>
        <input type="date" class="form-control" id="kalibrasiulang" name="kalibrasiulang" value="<?php echo $data['kalibrasi_ulang']; ?>" >
        </div>
                <!-- Tambahkan elemen-elemen lainnya sesuai kebutuhan -->
                <div class="col-md-6">
        <label for="" class="col-form-label">Lokasi Alat</label>
        <select class="form-select" id="lokasialat" name="lokasialat" >
        <option selected><?php echo $data['lokasi']; ?></option>
        ...
        <input type="text" class="form-control" id="petugas" name="petugas" value="<?php echo $data['petugas']; ?>" >
        </div>
                <!-- Tambahkan elemen-elemen lainnya sesuai kebutuhan -->
                <div class="col-md-6">
            ...
            <textarea class="form-control" id="catatanalat" name="catatanalat" rows="3" placeholder="Catatan Anda" value="<?php echo $data['catatan']; ?>" ></textarea>
        </div>
        <div class="col-12">
